            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    api.registrarVivienda(nombretextField_3.getText(), apellidotextField_4.getText(), dnitextField.getText(),
                            calletextField_1.getText(), Integer.parseInt(nrotextField.getText()), barriotextField_2.getText());



                    JOptionPane.showMessageDialog(null, labels.getString("registro.viviendas.mensaje.carga.correcta"), "Info", JOptionPane.INFORMATION_MESSAGE);
                    setVisible(false);
                    dispose();
